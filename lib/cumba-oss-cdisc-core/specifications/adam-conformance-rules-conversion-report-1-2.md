# ADaM Conformance Rules v4.0 — ADaMIG v1.2 Conversion Report

Conversion report for the ADaMIG v1.2 rule set.

## Summary

| Status | Count | % |
|--------|-------|---|
| Fully Executable | 287 | 50% |
| Template (RuleGenerator) | 277 | 48% |
| Manual | 6 | 1% |
| **Total** | **570** | |

---

## Template Rules (277 rules)
...
### Record-Level Populated Pairing (59 rules)
...
### Uniqueness / 1:1 Relationship (63 rules)
...
### Complex / Multi-Variable (17 rules)

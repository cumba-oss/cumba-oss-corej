...
class DefineXmlMetadataProviderTest
{
    ...
    private static net.cumba.cdisc.core.exec.MetadataProvider fallback()
    {
        return new net.cumba.cdisc.core.exec.StubMetadataProvider()
                .variable("DM",
    ...
    void declaredStructureKeyedProducts_delegatesToFallbackAndDefaultsEmpty()
    {
        ...
        net.cumba.cdisc.core.exec.MetadataProvider fb = org.mockito.Mockito
                .mock(net.cumba.cdisc.core.exec.MetadataProvider.class);

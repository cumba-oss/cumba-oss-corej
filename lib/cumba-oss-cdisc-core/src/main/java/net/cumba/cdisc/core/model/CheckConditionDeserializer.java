...
public class CheckConditionDeserializer extends StdDeserializer<CheckCondition>
{
        ...
        throws IOException
    {
        ...
        if (node.has("expression"))
        {
            ...
            net.cumba.cdisc.core.expr.ast.Expr expr = net.cumba.cdisc.core.expr.CheckExpressionParser
                    .parse(source);
            try
            {
                return net.cumba.cdisc.core.expr.ExprLowering.toCheckCondition(expr);
            }

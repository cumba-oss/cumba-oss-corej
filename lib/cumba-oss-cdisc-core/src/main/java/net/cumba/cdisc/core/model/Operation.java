...
public class Operation
{
     ...
     * field form via
     * {@link net.cumba.cdisc.core.expr.convert.OperationExpressionParser#normalize(Operation)} at
     * load time, so {@link net.cumba.cdisc.core.exec.OperationExecutor} only ever sees field-form
     ...
     * {@code name} field is ignored and {@link net.cumba.cdisc.core.exec.OperationExecutor} builds
     ...
     * by {@link net.cumba.cdisc.core.model.OperationType#MINUS}; {@code null} for every other
     ...
     * {@link net.cumba.cdisc.core.exec.OperationExecutor#evalMinus} uses this literal list as the
     ...
     * {@link net.cumba.cdisc.core.model.OperationType#MINUS}; a positional list is already claimed
     ...
     * {@link net.cumba.cdisc.core.model.OperationType#DY}; printed as the {@code reference="…"}
     ...
     * — so the converter ({@link net.cumba.cdisc.core.expr.convert.SplitByInliner}) lowers a
     ...
     * {@link net.cumba.cdisc.core.exec.GroupSemantics#sortByOrderColumn} string ordering) and the
     ...
     * {@link net.cumba.cdisc.core.metadata.SdtmObservationClasses#normalise} (e.g.
     ...
     * {@link net.cumba.cdisc.core.exec.OperationExecutor#evalHasMixedEmptinessWithinGroup} skips

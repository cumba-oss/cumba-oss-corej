 ...
 * ({@link net.cumba.cdisc.core.RulePackageLoader#installNativeExpr}) — so the parity Java lane
...
public final class VariableExistsInliner
{
     ...
     *
     * <p>
     * Requires {@link net.cumba.cdisc.core.model.OperationType#VARIABLE_EXISTS} to exist — without
            ...
            @Nullable List<String> outputVariables)
    {
        ...
        for (String ov : outputVariables)
        {
            ...
            if (!net.cumba.cdisc.core.model.OutputVariableToken.isExclusion(ov)

package net.cumba.cdisc.core.expr.eval.spi;
...
import net.cumba.cdisc.core.expr.eval.ComputedVector;
import net.cumba.cdisc.core.expr.eval.ConstVector;
import net.cumba.cdisc.core.expr.eval.EvalFunction;
import net.cumba.cdisc.core.expr.eval.FunctionDescriptor;
import net.cumba.cdisc.core.expr.eval.FunctionKind;
import net.cumba.cdisc.core.expr.eval.FunctionProvider;
import net.cumba.cdisc.core.expr.eval.IsoDateComparison;
import net.cumba.cdisc.core.expr.eval.Primitives;
import net.cumba.cdisc.core.expr.eval.Vector;
 ...
 * {@link net.cumba.cdisc.core.exec.EvaluationContext} and the operand name, not its row values).
 * </p>
 */

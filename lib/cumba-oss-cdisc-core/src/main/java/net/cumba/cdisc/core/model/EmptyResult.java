 ...
 * {@link net.cumba.cdisc.core.exec.GroupedResult} constructor the neighbouring evaluator happened
 ...
 *
 * <p>
 * For operations that build a {@link net.cumba.cdisc.core.exec.GroupedResult} the declaration is
...
public enum EmptyResult
{
     ...
     * and its consumer, {@link net.cumba.cdisc.core.exec.GroupedResult#missingKeyDefault()}, is
     ...
     * {@link net.cumba.cdisc.core.exec.GroupedResult#GroupedResult(List, java.util.Map, Object)} as

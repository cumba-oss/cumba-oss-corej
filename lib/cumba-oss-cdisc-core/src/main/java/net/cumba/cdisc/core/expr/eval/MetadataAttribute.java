...
import static net.cumba.cdisc.core.expr.eval.MetadataLevel.DATA;
import static net.cumba.cdisc.core.expr.eval.MetadataLevel.DEFINE;
import static net.cumba.cdisc.core.expr.eval.MetadataLevel.LIBRARY;
...
public enum MetadataAttribute
{
     ...
     * ({@link net.cumba.cdisc.core.metadata.DefineMetadataListCodec}) and materialised by the

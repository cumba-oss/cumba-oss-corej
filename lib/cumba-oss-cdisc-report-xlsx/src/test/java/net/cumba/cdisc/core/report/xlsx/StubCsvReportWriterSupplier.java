 ...
 * {@code src/test/resources/META-INF/services/net.cumba.cdisc.core.report.ReportWriterSupplier}. No
 * engine class was edited to make {@code csv-stub} appear in
 * {@link net.cumba.cdisc.core.report.ReportManager#getSupportedReportFormats()} —

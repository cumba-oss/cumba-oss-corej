...
class AdamGapRevalidationMechanismProbeTest
{
    ...
    void cdiscAd0084_shipsFullyExecutable_loadsClean_executesWithoutError()
    {
        ...
        assertEquals(net.cumba.corej.core.model.Executability.FULLY_EXECUTABLE,
    ...
    private static Rule expandedAd0353(IDataTable bds)
    {
        ...
        List<Rule> expansions = net.cumba.corej.core.gen.WildcardExpander.expand(template,
                bds.getMetaData());
    ...
    void cdiscAd0353_expansionBindsTheOperationName()
    {
        ...
        List<net.cumba.corej.core.model.Operation> ops = expanded.getOperations();
        assertNotNull(ops);

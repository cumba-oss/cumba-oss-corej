...
public class EvaluationContext
{
     ...
     * {@link net.cumba.corej.core.expr.eval.MetadataLevel#DEFINE} provider gate, exactly like
     ...
     *
     * <p>
     * It lives on the <em>context</em> rather than on the {@link net.cumba.corej.core.model.Rule}
     ...
     * </p>
     */
    net.cumba.corej.core.expr.ast.@Nullable Expr checkExprOverride;
     ...
     * {@link net.cumba.corej.core.model.Rule} instance is shared across datasets and across the

 ...
 * ({@link net.cumba.corej.core.exec.ScopeMatcher#describeDataStructureMismatch}) and the FU-4 "ADAM
 ...
 * {@link net.cumba.corej.core.exec.ScopeMatcher} matches by exact normalised token, so a detector
...
public final class AdamDataStructureDetector
{
     ...
     * {@link net.cumba.corej.core.exec.ScopeMatcher}: the matcher stays a pure exact-match over a

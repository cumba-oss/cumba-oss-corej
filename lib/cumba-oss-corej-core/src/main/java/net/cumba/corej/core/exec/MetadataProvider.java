...
public interface MetadataProvider
{
     ...
     *            {@link net.cumba.corej.core.metadata.AdamDataStructureDetector#detectAll} (e.g.
     *            {@code BASIC DATA STRUCTURE})
     * @param subclassTokens
     *            the dataset's resolved subclass tokens, most-specific first
     *            ({@link net.cumba.corej.core.metadata.AdamSubclassDetector#resolve}); empty when
     ...
     *            {@link net.cumba.corej.core.metadata.SdtmObservationClasses#MODEL_CLASS_NAMES}.
     ...
     * {@link net.cumba.corej.core.metadata.CdiscDomainResolver#cdiscDomainOf} — should prefer this

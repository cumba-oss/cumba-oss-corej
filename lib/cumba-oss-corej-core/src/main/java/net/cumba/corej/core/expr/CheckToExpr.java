...
public final class CheckToExpr
{
     ...
     * {@code net.cumba.corej.core.expr.convert.OperationInliner}). Only the two membership
     ...
     * bare-reference form whose {@link net.cumba.corej.core.expr.OperandKind} classification

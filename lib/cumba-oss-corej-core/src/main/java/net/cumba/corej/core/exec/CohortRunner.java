 ...
 * ({@link net.cumba.corej.core.expr.eval.Primitives#equality} / {@link ScalarSemantics}) — any
...
public final class CohortRunner
{
    ...
    private static @Nullable BitSet nativeBitsOrNull(Rule rule, EvaluationContext ctx)
    {
        ...
        return net.cumba.corej.core.expr.eval.NativeExprEvaluator.evaluate(rule.getCheckExpr(),
                ctx);
    }
     ...
     * {@link net.cumba.corej.core.expr.eval.Primitives#equality} or its dependents

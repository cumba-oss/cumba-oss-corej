...
public enum OperationType
{
     ...
     * dataset. Returns a {@link net.cumba.corej.core.exec.VariableMetadataResult} that resolves
     ...
     * {@link net.cumba.corej.core.exec.OperationExecutor#isLibraryDependent}): the rule SKIPs when
     ...
     * {@link net.cumba.corej.core.exec.OperationExecutor#isDefineDependent}): the rule SKIPs (never
     ...
     * {@link net.cumba.corej.core.exec.OperationExecutor#isDefineDependent}): the rule SKIPs when
     ...
     * {@link net.cumba.corej.core.exec.GroupedResult} keyed by the {@code name} column, value the
     ...
     * ({@link net.cumba.corej.core.exec.ScalarSemantics#detectIsoPrecision}, measured after each
     ...
     * Result shape: {@link net.cumba.corej.core.exec.GroupedResult} keyed by the {@code name}
     ...
     * {@link net.cumba.corej.core.exec.OperationExecutor#unsplitNameFromData} — equals the current
     ...
     * {@link net.cumba.corej.core.exec.DatasetResolver.WithInventory} to enumerate the family.
     ...
     * integer column. Result shape: {@link net.cumba.corej.core.exec.GroupedResult} keyed by the
     ...
     * default a {@link net.cumba.corej.core.exec.GroupedResult} built for this operation carries. A
